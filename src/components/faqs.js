...
export default function Faqs(props) {
             ...
             return (
                <Card style={{minWidth: 275,
                  ...
                  <CardContent >
                    ...
                    <div style={{float:'left',fontSize:'60px', color:'white'}}><i>{result.questionNumber}</i></div><br/>
                    <Typography variant="h5" component="h2" style={{marginTop:'-5px'}}>
                      {result.question}
                    </Typography>
 ...
 setIsLoaded(true);
  ...
  {heading}
  {(isLoaded && (faqs))||(!isLoaded && (<CircularProgress id={'loader'} size={100} thickness={20} style={{color:'black'}}/>))}

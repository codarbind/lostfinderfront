...
function claim(e, itemId) {
  ...
  if (retrievedToken) {
    ...
    document.getElementById("message").innerHTML =
      "you need to log in to claim item";
...
const Iamtheowner = (props) => {
  alert(
    "Please note that you can only submit claim on this particular item once, and you need to log in."
  );
        ...
        <form id={"form"}>
          ...
          <div>
            <label for="longDescription">
              <b>Describe the Item in Details</b>
            </label>
            <textarea
              id="1"
              name="description"
            ...
            <input
              type="text"
              placeholder="List all possible places you could have lost it"
              id={"2"}
              name="location"
              required
              className={classes.signInput}
            ...
            <label for="time">
              <b>When Last Did You See the Item?</b>
            </label>
            <input
              type="text"
